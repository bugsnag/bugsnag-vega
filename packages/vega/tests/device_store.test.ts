...
describe('vega device store', () => {
    ...
    it('loads device id from file if it exists', () => {
        ...
        const getCalls = (BugsnagVegaNative.getDeviceID as jest.Mock).mock.calls
        expect(getCalls).toHaveLength(0)
        const setCalls = (BugsnagVegaNative.setDeviceID as jest.Mock).mock.calls
    ...
    it('generates and saves device id if file did not exist', () => {
        ...
        (BugsnagVegaNative.getDeviceID as jest.Mock).mockReturnValue("ab0c1482-2ffe-11eb-adc1-0242ac120002");
