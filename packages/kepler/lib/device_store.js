import { BugsnagKeplerNative, BugsnagFileIO, isErrorResult } from '@bugsnag/kepler-native'
    ...
    load: function () {
      ...
      if (!isErrorResult(result)) {
        try {
          ...
          if (savedDeviceID.id) {
            BugsnagKeplerNative.setDeviceID(savedDeviceID.id)
      ...
      const deviceID = BugsnagKeplerNative.getDeviceID()
