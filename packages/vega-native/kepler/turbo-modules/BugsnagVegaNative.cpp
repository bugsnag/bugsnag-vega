...
std::string BugsnagVegaNative::getDeviceID() { return this->device_id; }
...
void BugsnagVegaNative::leaveBreadcrumb(JSObject crumb) {
  if (this->bugsnag == nullptr) {
    return;
  }
...
void BugsnagVegaNative::setUser(JSObject userInfo) {
  if (this->bugsnag == nullptr) {
    return;
  }
...
void BugsnagVegaNative::setApp(JSObject appInfo) {
  if (this->bugsnag == nullptr) {
    return;
  }
...
void BugsnagVegaNative::setDevice(JSObject deviceInfo) {
  if (this->bugsnag == nullptr) {
    return;
  }
