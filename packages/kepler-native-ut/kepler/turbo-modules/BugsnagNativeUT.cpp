...
#include "../../../kepler-native/kepler/turbo-modules/BugsnagFileIO.h"
...
namespace bugsnag
{
    ...
    BugsnagNativeUT::BugsnagNativeUT() : TM_API_NAMESPACE::KeplerTurboModule("BugsnagNativeUT")
    {
    }

    void BugsnagNativeUT::aggregateMethods(TM_API_NAMESPACE::MethodAggregator<TM_API_NAMESPACE::KeplerTurboModule> &methodAggregator) const noexcept
    {
