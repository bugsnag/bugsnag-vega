...
namespace bugsnag {
static utils::json::JsonContainer createErrorResult(utils::json::JsonContainer container) {
...
utils::json::JsonContainer BugsnagFileIO::writeTextFile(std::string path, std::string content) {
    auto result = utils::json::JsonContainer::createJsonObject();
